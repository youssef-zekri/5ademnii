...
const StepStyle = styled.div`
  ...
  border: 3px solid ${({ step }) => (step === "completed" ? "#aa59aa" : "#F3E7F3")};
  transition: 0.4s ease;
  display: flex;
        ...
        {activeStep === 1 ? (
          <>
            ...
            <div className="Register-category">
              <article
                ...
                className={
                  toggleselect ? "Register-category-select" : "Register-category-select c1"
                }
              >
                company
              </article>
              <article
                ...
                className={
                  toggleselect ? "Register-category-select c2" : "Register-category-select"
                }
              >
                client
              </article>
          ...
          <div className="Register-about">
            ...
            <div className="Register-info">
              ...
              <p className="subtitels">speciality :</p>
              <MultiSelect
                options={options}
                value={selected}
          ...
          <div className="Register-done">
            ...
            <Link to="/login" className="Register-done--link">
              let's Start
            </Link>
          </div>
        )}
